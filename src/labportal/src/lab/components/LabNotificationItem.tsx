...
import { Package, Factory, Clock, Eye, FlaskConical } from 'lucide-react';
...
export const LabNotificationItem: React.FC<NotificationItemProps> = ({ notification, onClick, onMarkAsRead }) => {
  const getIcon = () => {
