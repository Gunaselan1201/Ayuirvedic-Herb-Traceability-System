...
import { X, Bell, CheckCircle2, XCircle, Package, FlaskConical } from 'lucide-react';
...
interface LabNotificationSidebarProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function LabNotificationSidebar({
  isOpen,
  onClose,
  notifications,
  unreadCount,
            ...
            {notifications.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-xs text-gray-400 mt-1">
                  You'll see updates about batches here
                </p>
              </div>
            ) : (
