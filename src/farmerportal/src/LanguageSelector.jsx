...
const LanguageSelector = ({ currentLanguage, onLanguageChange, onBack }) => {
  const languages = [
  ...
  return (
    <div className="fixed inset-0 bg-white z-50 overflow-y-auto">
      {/* Header */}
      <div className="bg-gradient-to-r from-green-200 via-blue-200 to-blue-400 px-6 py-4 sticky top-0 z-10 shadow-md">
