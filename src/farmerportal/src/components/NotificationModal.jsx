...
import { CheckCircle2, XCircle, Package, Factory, Clock } from 'lucide-react';
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {notification.reason && (
                <div className="bg-white border border-gray-200 rounded-lg p-3 col-span-2">
                  <p className="text-xs text-gray-500 uppercase font-semibold mb-1">Rejection Reason</p>
                  <p className="text-sm font-bold text-red-600">{notification.reason}</p>
                </div>
              )}
            </div>
          </div>
